...
($link = mysqli_connect($GLOBALS['mysql_server'], $GLOBALS['mysql_username'], $GLOBALS['mysql_password'])) or checkSpace();
mysqli_select_db($link, $GLOBALS['mysql_database']) or setup();
?>
